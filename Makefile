...
OBJS=token.o line_parser.o advanced_mode.o char_buffer.o command_mode.o editor.o file_link_mode.o find_mode.o help_command.o insert_mode.o lazy_string.o lazy_string_append.o main.o map_mode.o memory_mapped_file.o noop_command.o repeat_mode.o substring.o terminal.o
edge: $(OBJS)
