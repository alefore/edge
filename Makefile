...
command_mode.o: command_mode.cc command_mode.h advanced_mode.h command.h editor_mode.h editor.h find_mode.h help_command.h map_mode.h repeat_mode.h Makefile
...
OBJS=token.o line_parser.o advanced_mode.o char_buffer.o command_mode.o editor.o file_link_mode.o find_mode.o help_command.o main.o map_mode.o memory_mapped_file.o repeat_mode.o substring.o terminal.o
editor: $(OBJS)
